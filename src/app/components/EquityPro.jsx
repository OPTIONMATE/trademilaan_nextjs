    ...
    <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-700">
          <li><b>Segment:</b> Focus on Stocks.</li>
          <li><b>Call Frequency:</b> Monthly (3–5 Research Calls).</li>
          <li><b>Capital Required:</b> ₹100,000.</li>
          <li><b>Average Stop-Loss:</b> 3%–10%.</li>
