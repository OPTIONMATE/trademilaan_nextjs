    ...
    <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-700">
          <li><b>Segment:</b> Focus on Future & Options, specifically Index Options.</li>
          <li><b>Call Frequency:</b> Weekly (3–10 Calls).</li>
          <li><b>Capital Required:</b> ₹1,00,000.</li>
          <li><b>Average Stop-Loss:</b> 12%–15%.</li>
